...
def get_filters():
    ...
    while city not in ['chicago', 'new york city', 'washington']:
        city = input("City is name is invalid! I have data on three cities. Please input chicago, new york city or washington: ").lower()

    pass

    # get user input for month (all, january, february, ... , june)
    month = input("Please input a month, january through june or all: ").lower()

    while month not in ['january', 'february', 'march', 'april', 'may', 'june']:
    month = input( "Month selection is invalid! Data only available january through june. Please select again: ").lower()

    pass
    # get user input for day of week (all, monday, tuesday, ... sunday)
    day = input("Please input a day of week, Monday through Sunday or all: ").lower()
